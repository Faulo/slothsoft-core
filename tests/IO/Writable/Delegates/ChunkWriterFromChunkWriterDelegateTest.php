 ...
 *
 * @see ChunkWriterFromChunkWriterDelegate
 */
final class ChunkWriterFromChunkWriterDelegateTest extends TestCase implements ChunkWriterInterface {
    ...
    public function test_values(int $count) {
        $sut = new ChunkWriterFromChunkWriterDelegate(function () {
            return $this;
        });
